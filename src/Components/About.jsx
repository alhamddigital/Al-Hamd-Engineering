...
const About = () => {
    ...
    return (
        <>
            <div ref={aboutRef} id='consAbout' className='w-full h-max px-3 lg:px-[100px] py-4 md:py-9 overflow-hidden'>
