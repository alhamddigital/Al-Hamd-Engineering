...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs
            .sendForm('service_8y3kcda', 'template_2n73jri', formRef.current, {
                publicKey: 'BEe2CYm5VLagzvu13',
            })
            .then((result) => {
    ...
    return (
        <>
            <div id='consContact' ref={contactRef} className='bg-gray-200'>
                <section className="">
                    <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contact Us</h2>
                        <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Have a question or need support? We're here to help. Reach out to us with any queries, feedback, or concerns and we'll get back to you as soon as possible!</p>
